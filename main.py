...
url = 'https://github.com/Pringle-Null/Sinfull-Selfbot/master/update.json'
...
async def on_connect():
  print (f'Sinfull Selfbot.PY {version}\nLogged in as: {bot.user}\nCurrent Prefix: {prefix}\n\nChangelog:\n{changelog}\n\nMade by CrafterPika and Sinfull SelfbotJB')
  latestver = cont['latest']
  if latestver == version:
      print ("Sinfull Selfbot.PY is up to date!")
  else:
      print ("Please update from the github page (https://github.com/Pringle-Null/Sinfull-Selfbot/)")
      try:
          sys.exit()
      except:
